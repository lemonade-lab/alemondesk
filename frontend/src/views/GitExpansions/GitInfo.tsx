...
import { GitCheckout, GitLog, GitPull, GitTags ,GitBranch} from '@wailsjs/go/windowgit/App'
...
const GitBranchesLogs = ({
  ...
  useEffect(() => {
    GitLog(name, branch).then((data: any) => {
          ...
          <Tabs
            ...
            items={[
              ...
              },
              {
                ...
                children: <GitTagsR name={item} onShow={onShowReadme} />
              }
            ]}
          />
        )
